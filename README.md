...
### Note:- Upon clicking any of the refresh news or news or portfolio or update portfolio or analyse or buy or sell buttons please wait for around 30 to 40 seconds as it takes time to search and load the real time market data. For best experience use when the markets are open.
